...
class Settings(BaseSettings):
    ...
    # Le mode permissif est désactivé automatiquement en production.
    ...
    # Garde-fou contre les boucles de l’agent.
    AGENT_MAX_ITERATIONS: int = 6

    # Le seuil est vérifié côté backend, jamais décidé par le LLM.
    AGENT_ESCALATION_MAX_FAILED_ATTEMPTS: int = 2

    # Valeur commune pour éviter des délais incohérents entre fournisseurs.
    ...
    # Ce modèle est retenu pour sa fiabilité avec les appels d’outils.
    OLLAMA_BASE_URL: str = "http://localhost:11434/v1"
    OLLAMA_MODEL: str = "qwen2.5:3b"
    OLLAMA_API_KEY: str | None = None
    # Une fenêtre explicite évite de tronquer l’historique et les extraits RAG.
    ...
    # Le client embarqué sert aux tests ; le serveur distant sert aux déploiements.
